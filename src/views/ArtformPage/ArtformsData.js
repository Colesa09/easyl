//Artform data page.
//These imports are for the main artform pcitures used on the homepage and the individual artform page.
...
//Import the pictures, used for the artform gallery, in one call for each artform file.
...
const imageListPainting = imagesPainting.keys(imagesPainting).map((image, index) => ({
    ...
    path: `tutorial/${image}`, // Path to be used for single Tutorial Page
    alt: '', 
...
//This is the Artforms array of objects. 
const Artforms = [
    {
      id: 'painting', 
      name: 'Painting', 
    ...
    },
    {
      id: 'literature', 
      name: 'Literature', 
      imgSrc: LiteraturePic, 
      alt:'literature pic', 
      path: 'artforms/literature',
